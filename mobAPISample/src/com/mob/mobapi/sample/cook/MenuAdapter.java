...
public class MenuAdapter extends BaseAdapter implements APICallback {
	...
	public void requestMenu() {
		...
		api.searchMenu(ctgId, pageIndex + 1, PAGE_SIZE, this);
	}
	...
	public void onSuccess(API api, int action, Map<String, Object> result) {
		...
		for (HashMap<String, Object> res : resultList) {
			HashMap<String, Object> recipe = (HashMap<String, Object>) res.get("recipe");
			String tmp = (String) recipe.get("ingredients");
			if (tmp != null) {
				recipe.put("ingredients", hashon.fromJson("{\"list\":" + tmp + "}").get("list"));
			}
			tmp = (String) recipe.get("method");
			if (tmp != null) {
