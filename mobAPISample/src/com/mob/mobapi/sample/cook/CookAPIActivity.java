...
public class CookAPIActivity extends Activity implements APICallback, OnItemSelectedListener,
		OnClickListener {
	...
	public void onSuccess(API api, int action, Map<String, Object> result) {
		...
		HashMap<String, Object> categoryInfo = (HashMap<String,Object>) result.get("categoryInfo");
		category1List.clear();
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
		if (parent.equals(spCategory1)) {
			...
			ArrayList<HashMap<String, Object>> category2List
					= (ArrayList<HashMap<String, Object>>) category1List.get(position).get("childs");
