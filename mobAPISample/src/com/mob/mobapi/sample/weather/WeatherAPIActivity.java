...
public class WeatherAPIActivity extends Activity implements APICallback, OnItemSelectedListener {
	...
	private void onWeatherDetailsGot(Map<String, Object> result) {
		...
		tvCold.setText(com.mob.tools.utils.R.toString(weather.get("cold_index")));
		tvDressing.setText(com.mob.tools.utils.R.toString(weather.get("dressing_index")));
		tvExercise.setText(com.mob.tools.utils.R.toString(weather.get("exercise_index")));
		tvWash.setText(com.mob.tools.utils.R.toString(weather.get("wash_index")));
		String time = com.mob.tools.utils.R.toString(weather.get("crawlerTime"));
